insert into produto (id, nome, preco, data_criacao, ativo, descricao) values (1, 'Kindle', 499.0, date_sub(sysdate(), interval 1 day), 'SIM', 'Conheça o novo Kindle, agora com iluminação embutida ajustável, que permite que você leia em ambientes abertos ou fechados, a qualquer hora do dia.');
insert into produto (id, nome, preco, data_criacao, ativo, descricao) values (3, 'Camera GoPro', 1500.0, date_sub(sysdate(), interval 1 day), 'SIM', 'Uma excelente câmera para gravar seus sports!');
insert into produto (id, nome, preco, data_criacao, ativo, descricao) values (99, 'Camera GoPro HERO', 1499.0, date_sub(sysdate(), interval 1 day), 'NAO', 'Uma excelente câmera para gravar suas pescarias');
